...
public class GameProcessorImpl implements GameProcessor {
  ...
  public GameProcessorImpl(IOService ioService,
    ...
    System.out.println("INIT: GameProcessorImpl " + ioService);
    System.out.println("INIT: GameProcessorImpl " + equationPreparer);
    System.out.println("INIT: GameProcessorImpl " + playerService);
