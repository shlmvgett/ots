...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
    EntityClassMetaData<Manager> metaDataManager = new EntityClassMetaDataImpl<>(Manager.class);
    var dataTemplateManager = new DataTemplateJdbc<>(dbExecutor, metaDataManager);
