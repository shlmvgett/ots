...
public class AtmHelpers {
  ...
  public static Atm prepareAtm() {
    BanknotesBox banknotesBox = new BanknotesBoxImpl(Currency.getInstance("RUB"),
        new TreeMap<>(Map.of(
            Denomination.D_100,
            List.of(new Banknote(100), new Banknote(100), new Banknote(100), new Banknote(100), new Banknote(100), new Banknote(100)),
            Denomination.D_1000,
    ...
    return new AtmImpl(banknotesBox);
  }
}
